...
class PatientServiceProvider extends ServiceProvider
{
    ...
    {
        $this->publishes([
            module_path('Patient', 'Config/config.php') => config_path('patient.php'),
        ], 'config');
        $this->mergeConfigFrom(
            module_path('Patient', 'Config/config.php'), 'patient'
        );
    }
    ...
    {
        $viewPath = resource_path('views/modules/patient');

        $sourcePath = module_path('Patient', 'Resources/views');
    ...
    {
        $langPath = resource_path('lang/modules/patient');
    ...
    public function registerFactories()
    {
        if (! app()->environment('production') && $this->app->runningInConsole()) {
            app(Factory::class)->load(module_path('Patient', 'Database/factories'));
        }
    }
